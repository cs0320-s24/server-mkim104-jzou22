...
/**
 * This is a search class which is called by the user repl. This search takes in the parsed
 * data and depending on the user input, it will search through the parse data.
 */
public class CSVSearcher {
  ...
  /**
   * Searches through the CSV data using the specified column index as the identifier.
   * This is used whenever we have a column identifier or whenever a type is defined is given.
   * @param data       The CSVParser object containing the CSV data.
