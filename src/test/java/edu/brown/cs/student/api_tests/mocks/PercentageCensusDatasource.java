...
/**
 * Interface representing a percentage census data source. Implementing classes are responsible for
 * providing percentage census data for a given state and county.
 */
