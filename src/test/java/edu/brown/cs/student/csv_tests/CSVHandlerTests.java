...
//        server.registerHandler("/viewcsv", viewCSVHandler);
    ...
    public void testViewAndSearchBeforeLoading() throws IOException {
        URL url = new URL("http://localhost:3232/searchcsv?searchValue=Cranston&header=true&columnIdentifier=City/Townd&columnType=");
    ...
    public void testSearchLoadedFile() throws Exception {
        ...
        URL url = new URL("http://localhost:3232/searchcsv?searchValue=Rhode%20Island&header=true&columnIdentifier=City/Townd&columnType=");
        HttpURLConnection connection = (HttpURLConnection) url.openConnection();
        connection.setRequestMethod("GET");
