...
//                new CSVSearcher(searchCSV.getParseArray(), "2%", "Employed Percent", true, "N");
//
...
//        CSVParser<List<String>> searchCSV = new CSVParser<>(searchReader, rowCreator);
//        CSVSearcher searcher =
//                new CSVSearcher(searchCSV.getParseArray(), "2.2222222%", "Employed Percent", true,
// "N");
//
...
//        RowCreator rowCreator = new RowCreator();
//        CSVParser<List<String>> searchCSV = new CSVParser<>(searchReader, rowCreator);
//        CSVSearcher searcher = new CSVSearcher(searchCSV.getParseArray(), "2%", "State", true,
// "N");
//
//        // Assert that the result matches the expected list
//        Assert.assertEquals(List.of(), searcher.getResult());
...
//        RowCreator rowCreator = new RowCreator();
//        CSVParser<List<String>> searchCSV = new CSVParser<>(searchReader, rowCreator);
//        CSVSearcher searcher = new CSVSearcher(searchCSV.getParseArray(), "5.36884", "4", true,
// "I");
//
//        // Initialize the expected result list
//        List<List<String>> expected =
...
//        RowCreator rowCreator = new RowCreator();
//        CSVParser<List<String>> searchCSV = new CSVParser<>(searchReader, rowCreator);
//        CSVSearcher searcher = new CSVSearcher(searchCSV.getParseArray(), "5.36884", "Z", true,
// "N");
//
//        // Initialize the expected result list
//        List<List<String>> expected =
